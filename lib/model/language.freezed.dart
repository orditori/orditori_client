...
class _$LanguageTearOff {
  ...
  _Language call({required String name, required String code}) {
    return _Language(
      name: name,
      code: code,
    );
...
class _$_Language implements _Language {
  _$_Language({required this.name, required this.code});
...
abstract class _Language implements Language {
  factory _Language({required String name, required String code}) = _$_Language;
